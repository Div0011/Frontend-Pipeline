#!/usr/bin/env python3
"""
Deploy bulletproof, rich, high-contrast, fully visible Menu Slabs across all 24 projects:
- Guarantees 100% visibility of all menu items (no blank screens or hidden opacity).
- Category filtering with "All" enabled by default so all items are immediately visible on page load.
- Dual-theme solid high-contrast card slabs (rich dark cards in dark mode, crisp elevated white cards in light mode).
- Authentic brand menu data for each website.
"""
...
def build_menu_page(cfg: dict) -> str:
    primary = cfg.get("primary", "#C68A14")
    btn_text = cfg.get("btn_text", "#FFFFFF")
...
def main():
    print("🚀 Deploying bulletproof Menu Slabs across all 24 projects...")
    for project_dir in sorted(PROJECTS_DIR.iterdir()):
        ...
        if menu_file.exists():
            ...
            print(f"  ✓ Deployed bulletproof menu slabs to {pname}")

    print("🎉 All Menu pages successfully updated with solid visible slabs!")
