        ...
        >
          <div className="space-y-6 max-w-3xl">
            <div className="flex items-center gap-2">
              ...
              <p className="type-caption text-yolk font-mono tracking-widest">
            ...
            <h1 className="type-display text-5xl sm:text-7xl lg:text-8xl xl:text-[6.5rem] leading-[0.88] tracking-tight text-ink">
              The Art of
              <br />
              <span className="text-yolk">the Burger</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Link
                href="/locations"
                className="inline-flex items-center gap-3 border border-ink/30 text-ink px-8 py-4 type-caption text-xs hover:border-yolk hover:bg-char-soft hover:text-yolk transition-all duration-500"
              >
        ...
        >
          <div className="space-y-6 max-w-xl text-left lg:text-right flex flex-col items-start lg:items-end w-full">
            ...
            <div className="flex justify-start lg:justify-end w-full">
              <Link
                href="/menu"
                className="inline-flex items-center gap-3 bg-yolk text-char px-8 py-4 type-caption text-xs font-bold hover:bg-yolk-light transition-colors duration-500 shadow-xl"
              >
                Order This Classic →
              </Link>
            </div>
