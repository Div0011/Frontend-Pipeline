...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={sidebarLeftRef}
        className="absolute left-6 bottom-12 hidden xl:block space-y-2 font-mono text-[9px] text-smoke tracking-widest leading-relaxed z-20"
      >
      ...
      <div
        ref={sidebarRightRef}
        className="absolute right-6 bottom-12 hidden xl:block space-y-2 font-mono text-[9px] text-smoke tracking-widest text-right leading-relaxed z-20"
      >
