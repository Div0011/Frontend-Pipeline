      ...
      <AnimatePresence>
        {activeVideo && (
          ...
          >
            <button
              onClick={() => setActiveVideo(null)}
              className="absolute top-6 right-6 type-caption text-xs text-bone hover:text-yolk border border-bone/20 hover:border-bone px-4 py-2 transition-all duration-300 z-60 font-mono"
            >
              Close Broadcast ✕
            </button>
            <motion.div
