...
from redesign.orchestrator import build_graph
from redesign.prompts import render_prompt
from redesign.runner import run_redesign
from redesign.tools import crawl_website, web_search
...
def test_prompt_renders_with_literal_braces():
    ...
    assert "{creative}" not in out
    assert "our art direction" in out
    assert '"path/relative/to/project"' in out  # literal braces preserved
