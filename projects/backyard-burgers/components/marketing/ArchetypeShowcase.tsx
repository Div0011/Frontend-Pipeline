      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-white/10 pb-6">
          ...
          <span className="font-mono text-xs text-stone-400">
            OPEN UNTIL 1:00 AM · Koramangala
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-2">
            ...
            <p className="type-display text-3xl font-bold" style={{ color: "#E67E22" }}>485°F HIGH SEAR</p>
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-2">
            ...
            <p className="type-display text-3xl font-bold" style={{ color: "#E67E22" }}>TILL 1:00 AM</p>
            <p className="text-xs text-stone-400">Serving midnight cravings across Koramangala every night.</p>
          </div>
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-2">
            <span className="font-mono text-[10px] uppercase text-stone-500">MONSTER PATTY WEIGHT</span>
            <p className="type-display text-3xl font-bold" style={{ color: "#E67E22" }}>100% PRIME CUTS</p>
