    ...
    <section className="py-24 px-6 sm:px-12 md:px-20 bg-transparent text-white border-b border-white/10 relative z-10 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-white/10 pb-6">
          <div>
            <span className="font-sans text-xs uppercase font-bold tracking-widest block" style={{ color: "#E67E22" }}>
              CURATED PAIRINGS
            </span>
              ...
              >
                <div className="flex items-center justify-between">
                  <span
                    ...
                    style={{ color: isSelected ? "#E67E22" : "#FAF8F2" }}
                  >
                    {p.number}. {p.title}
                  </span>
                  <span
                    className="w-2.5 h-2.5 rounded-full"
                    style={{ backgroundColor: isSelected ? "#E67E22" : "rgba(255,255,255,0.2)" }}
                  />
                </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-7 grid grid-cols-2 gap-4">
              <div className="relative h-64 sm:h-72 rounded-2xl overflow-hidden border border-white/15 bg-black/60 shadow-xl group">
                ...
                <div className="absolute bottom-3 left-3 right-3 font-sans">
                  ...
                  <p className="font-bold text-[11px]" style={{ color: "#E67E22" }}>₹{current.price}</p>
                </div>
              </div>
              ...
              <div className="relative h-64 sm:h-72 rounded-2xl overflow-hidden border border-white/15 bg-black/60 shadow-xl group">
                ...
                <div className="absolute bottom-3 left-3 right-3 font-sans">
                  ...
                  <p className="font-bold text-[11px]" style={{ color: "#E67E22" }}>₹{current.companionPrice}</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 space-y-6">
              <div>
                <span className="text-[10px] uppercase font-bold tracking-wider block" style={{ color: "#E67E22" }}>
                  {current.category}
                </span>
                ...
                {current.flavorProfile.map((fp, fIdx) => (
                  <div key={fIdx} className="space-y-1">
                    <div className="flex justify-between text-xs font-semibold">
                      ...
                      <span className="font-bold" style={{ color: "#E67E22" }}>{fp.value}%</span>
                    </div>
                    <div className="w-full h-1.5 rounded-full bg-white/10 overflow-hidden">
                      <div
                        className="h-full rounded-full transition-all duration-500"
                        style={{ width: `${fp.value}%`, backgroundColor: "#E67E22" }}
                      />
                    </div>
                  </div>
                ))}
