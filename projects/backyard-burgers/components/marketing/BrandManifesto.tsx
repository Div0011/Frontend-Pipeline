        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-4 border-b border-white/10">
          <div>
            <h2 className="type-display text-4xl sm:text-6xl md:text-7xl text-white font-black leading-tight tracking-tight">
              <ShinyText text="THE 450°F STEEL SMASH STANDARD." speed={3} shimmerColor="#E67E22" className="font-black" />
            </h2>
          </div>
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        color: isSelected ? "#E67E22" : "#A8A29E",
        ...
        {viewMode === "compare" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-sans">
            ...
            <div
              ...
              style={{ borderColor: "#E67E2240" }}
            >
              <span className="font-sans text-xs font-bold uppercase tracking-wider block" style={{ color: "#E67E22" }}>
                OUR CRAFT SPEC
              </span>
