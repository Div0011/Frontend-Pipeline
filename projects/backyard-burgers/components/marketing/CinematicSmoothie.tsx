              ...
              {HOTSPOTS.map((spot) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* Pulse Ring */}
                      <span className="animate-ping absolute inline-flex h-6 w-6 rounded-full bg-[#E67E22] opacity-75"></span>
                      
                      {/* Core Dot */}
                      <span className="relative inline-flex rounded-full h-3 w-3 bg-[#E67E22] border border-char"></span>
                      ...
                      <AnimatePresence>
                        {isHovered && (
                          ...
                          >
                            <p className="type-caption text-[#E67E22] text-[10px] mb-1">{spot.label}</p>
