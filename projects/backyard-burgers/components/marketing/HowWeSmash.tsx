      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="text-[10px] uppercase tracking-wider font-bold block" style={{ color: "#E67E22" }}>
                FLAT-TOP SIMULATOR
              </span>
            ...
            <div className="flex items-center gap-3">
              <span className="text-3xl font-black" style={{ color: "#E67E22" }}>
                {tempValue}°F
              </span>
              <span
          ...
          <div className="space-y-2 pt-4">
            ...
            <div className="flex justify-between text-[10px] text-stone-400 font-semibold uppercase">
              ...
              <span style={{ color: "#E67E22" }}>450°F (Optimal Crisp Sear)</span>
