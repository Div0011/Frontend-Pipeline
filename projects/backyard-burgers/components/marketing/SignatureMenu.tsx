...
const menuItems = [
  {
    "id": "smoked-bacon",
    "name": "Backyard Hickory Smoked",
    "category": "Smoked Burgers",
    "price": "390",
    "badge": "Wood Smoked",
          ...
          <div className="flex flex-wrap items-center gap-2 bg-white/5 p-1.5 rounded-full border border-white/10">
            {categories.map((cat: any) => (
              <button
                ...
                style={{
                  backgroundColor: selectedCategory === cat ? "#E67E22" : "transparent",
                }}
              >
                {cat}
              </button>
          ...
          {filteredItems.map((item: any) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                <h3 className="type-display text-xl sm:text-2xl text-white font-bold leading-tight group-hover:text-[#E67E22] transition-colors">
                  {item.name}
                </h3>
