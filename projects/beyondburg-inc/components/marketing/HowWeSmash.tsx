      ...
      <div className="max-w-6xl mx-auto space-y-14">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-6 border-b border-white/10 pb-8">
          <div className="space-y-2">
            <span className="font-mono text-xs tracking-widest uppercase block font-bold" style={{ color: "#F5C418" }}>
              BEYONDBURG INC. // CRAFT LAB &amp; SCIENCE
            </span>
        ...
        <div className="p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="font-mono text-[10px] uppercase tracking-wider font-bold" style={{ color: "#F5C418" }}>
            ...
            <div className="flex items-center gap-3">
              <span className="font-mono text-3xl font-black" style={{ color: "#F5C418" }}>
                {tempValue}°F
              </span>
              <span
                className="font-mono text-xs px-2.5 py-1 rounded border uppercase font-bold"
                style={{
                  backgroundColor: "#F5C41820",
                  color: "#F5C418",
                  borderColor: "#F5C41840",
                }}
              >
          ...
          <div className="space-y-2">
            <input
              ...
              style={{ accentColor: "#F5C418" }}
            />
            <div className="flex justify-between text-[10px] font-mono text-stone-400">
              <span>250°F (Slow Steam)</span>
              <span className="font-bold" style={{ color: "#F5C418" }}>450°F (Optimal Crisp Sear)</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="space-y-1.5 p-4 rounded-xl bg-black/40 border border-white/10">
              <div className="flex justify-between text-xs font-mono">
                ...
                <span className="font-bold" style={{ color: "#F5C418" }}>{crustPercent}%</span>
              </div>
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <motion.div
                  className="h-full"
                  style={{ width: `${crustPercent}%`, backgroundColor: "#F5C418" }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5 p-4 rounded-xl bg-black/40 border border-white/10">
              <div className="flex justify-between text-xs font-mono">
                ...
                <span className="font-bold" style={{ color: "#F5C418" }}>
              ...
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <motion.div
                  className="h-full"
                  style={{ width: `${tempValue >= 440 ? 98 : 75}%`, backgroundColor: "#F5C418" }}
                />
              </div>
            </div>
          </div>
