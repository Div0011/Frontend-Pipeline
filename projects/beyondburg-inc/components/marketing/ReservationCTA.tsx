    ...
    >
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-3">
          <span className="font-mono text-xs tracking-widest uppercase font-bold block" style={{ color: "#F5C418" }}>
            BEYONDBURG INC. TABLE RESERVATIONS
          </span>
          ...
          <p className="text-stone-300 text-sm max-w-xl mx-auto font-body">
            Reserve front-row seats for fresh sizzling craft dining in Bengaluru.
          </p>
        </div>
        ...
        {confirmed ? (
          ...
          >
            ...
            <div className="space-y-1">
              <span className="font-mono text-xs uppercase tracking-widest font-bold" style={{ color: "#F5C418" }}>
              ...
              <p className="font-mono text-xs text-stone-300">
                Booking Reference: <span className="font-bold" style={{ color: "#F5C418" }}>{bookingRef}</span>
              </p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4 bg-white/5 p-3 rounded-xl border border-white/10 justify-between">
                  ...
                  <div className="text-center font-mono">
                    <span className="text-2xl font-bold" style={{ color: "#F5C418" }}>{guestCount}</span>
