...
export default function ReservationCTA() {
  const [selectedLocation, setSelectedLocation] = useState("St. Mark's Flagship");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-6">
            <h3 className="type-display text-3xl sm:text-4xl text-white font-extrabold leading-tight">
              TABLE RESERVATIONS AT BEYONDBURG INC.
            </h3>
          </div>
              ...
              {!isBooked ? (
                <form onSubmit={handleBooking} className="space-y-4 text-black">
                  <div className="space-y-1">
                    ...
                    >
                    <option value="St. Mark's Flagship">St. Mark's Flagship</option>
                    <option value="Indiranagar Kitchen">Indiranagar Kitchen</option>
                    </select>
                  </div>
