...
const outposts = [{"id": "st-marks", "name": "St. Mark's Road Flagship", "badge": "ORIGINAL SMASH ATELIER", "address": "Opp. Bowring Institute, St. Mark's Rd", "city": "Bengaluru 560001", "hours": "11:30 AM \u2013 11:30 PM", "phone": "+91 90729 64242", "status": "Kitchen Active \u00b7 10 min table wait", "seating": "Chef's Sizzle Counter & Shaded Patio", "heroImage": "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1200&q=80", "gallery": ["https://images.unsplash.com/photo-1550547660-d9450f859349?w=800&q=80", "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80"], "mapUrl": "https://maps.google.com/?q=Beyondburg+Inc+Bangalore"}, {"id": "indiranagar", "name": "Indiranagar Craft Kitchen", "badge": "100FT ROAD OUTPOST", "address": "100 Feet Rd, HAL 2nd Stage", "city": "Bengaluru 560038", "hours": "12:00 PM \u2013 1:00 AM", "phone": "+91 90729 64243", "status": "Kitchen Active \u00b7 Open till 1:00 AM", "seating": "Neon Lounge & Outdoor Deck", "heroImage": "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&q=80", "gallery": ["https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=800&q=80", "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=800&q=80"], "mapUrl": "https://maps.google.com/?q=Beyondburg+Inc+Indiranagar"}];
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 border-b border-white/10 pb-8">
          <div className="space-y-2">
            <span className="font-mono text-xs tracking-widest uppercase block font-bold" style={{ color: "#F5C418" }}>
              BEYONDBURG INC. // PHYSICAL OUTPOSTS
            </span>
                  ...
                  <div className="flex items-center gap-2">
                    {allImages.map((img: string, iIdx: number) => (
                      <button
                        ...
                        style={{
                          borderColor: activeImageIndex === iIdx ? "#F5C418" : undefined,
                        }}
                      >
            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 flex flex-col justify-between shadow-2xl space-y-6">
              <div className="space-y-5">
                <div className="space-y-1.5">
                  <span className="font-mono text-[10px] tracking-widest uppercase font-bold block" style={{ color: "#F5C418" }}>
                    OUTPOST DETAILS
                  </span>
                  ...
                  <p className="font-mono text-xs font-bold" style={{ color: "#F5C418" }}>
                    {currentLoc.city}
                  </p>
                </div>
                ...
                <div className="space-y-2 text-xs font-mono text-stone-300 pt-2 border-t border-white/10">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold" style={{ color: "#F5C418" }}>{currentLoc.phone}</span>
                  </div>
                </div>
              </div>
