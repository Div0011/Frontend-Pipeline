        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-8 pb-8 border-b border-white/10">
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              <span className="w-2.5 h-2.5 rounded-full animate-ping" style={{ backgroundColor: "#F5C418" }} />
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="relative">
              <input
                ...
                style={{ borderColor: searchQuery ? "#F5C418" : undefined }}
              />
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                style={{
                  backgroundColor: isSelected ? "#F5C418" : undefined,
                  color: isSelected ? "#000000" : undefined,
                  borderColor: isSelected ? "#F5C418" : undefined,
                }}
              >
                {cat.label}
              </button>
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      <span className="font-sans text-[9px] uppercase tracking-widest font-bold" style={{ color: "#F5C418" }}>
                        BEYONDBURG INC. // #0{idx + 1}
                      </span>
                    ...
                    <span
                      ...
                      style={{
                        backgroundColor: "#F5C41815",
                        color: "#F5C418",
                        borderColor: "#F5C41840",
                      }}
                    >
                      ₹{item.price}
                    </span>
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <div>
                  ...
                  <span className="font-sans text-2xl font-black" style={{ color: "#F5C418" }}>
