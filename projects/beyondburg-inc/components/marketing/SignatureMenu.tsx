              ...
              >
                <div className="space-y-4">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span className="text-sm font-extrabold px-3 py-1 rounded-full border border-[#F5C418]/40 text-[#F5C418] bg-[#F5C418]/10 whitespace-nowrap shadow-sm">
                      ₹{item.price}
                    </span>
                  </div>
                </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                  ...
                  <span className="text-xl font-black text-[#F5C418]">
              ...
              <div className="flex gap-4 pt-4 border-t border-white/10">
                <button
                  ...
                  className="w-full py-3 rounded-full text-xs font-bold uppercase tracking-widest bg-[#F5C418] text-black hover:brightness-110 active:scale-95 transition-all shadow-xl"
                >
