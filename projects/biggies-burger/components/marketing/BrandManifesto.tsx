    ...
    <section className="py-24 px-6 sm:px-12 md:px-20 bg-transparent text-white border-b border-white/10 relative z-10">
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="flex items-center gap-3">
          <span className="h-[1px] w-12" style={{ backgroundColor: "#F97316" }} />
          <span className="font-mono text-xs tracking-widest uppercase font-bold" style={{ color: "#F97316" }}>
            <DecryptedText
              text="THE BIGGIES STANDARD // FLAME-GRILL SPEC"
              speed={40}
              maxIterations={12}
              animateOn="view"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <SpotlightCard
            spotlightColor="#F9731625"
            className="hover:border-white/40"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#F97316" }}>01 // HEAVY STEEL SMASH</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#F9731615", color: "#F97316", borderColor: "#F9731630" }}>
                  450°F
                </span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#F97316" }}>02 // SQUISHY POTATO BUNS</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#F9731615", color: "#F97316", borderColor: "#F9731630" }}>
                  GOLDEN
                </span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#F97316" }}>03 // CRAFT DIPS &amp; SHAKES</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#F9731615", color: "#F97316", borderColor: "#F9731630" }}>
                  HAND-SPUN
                </span>
              </div>
