      ...
      <div className="h-full max-w-[88rem] mx-auto px-6 lg:px-8">
        ...
        >
          <div className="space-y-6 max-w-3xl">
            <p className="type-caption text-gold font-mono tracking-widest">
              India&apos;s Flame-Grilled Pioneer · Est. 2011
            </p>
            <h1 className="type-display text-5xl sm:text-7xl lg:text-8xl xl:text-[6.5rem] leading-[0.88] tracking-tight text-ink">
              Pioneer of
              <br />
              <span className="text-gold">the Flame Grill</span>
            </h1>
            <p className="type-serif text-lg sm:text-xl md:text-2xl text-stone max-w-xl leading-relaxed">
              Where smoke meets artisanal fire. Over 130 stores nationwide,
              born on Church Street — grilled to perfection with authentic spice.
            </p>
        ...
        >
          <div className="space-y-6 max-w-2xl">
            <p className="type-caption text-gold font-mono tracking-widest">
              Phase 01 / Authentic Flame Char
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-ink leading-tight">
              Open-Flame<br />Charcoal Sear
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Every patty is seasoned with our proprietary 14-spice blend
              and flame-seared over open charcoal grates for an unmistakable smoky crust.
            </p>
            <div className="flex items-center gap-4 text-xs font-mono text-stone">
              ...
              <span>FLAME-SEAR VISUAL SEQUENCE</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="space-y-6 max-w-xl text-left lg:text-right flex flex-col items-start lg:items-end w-full">
            <p className="type-caption text-gold font-mono tracking-widest">
              Phase 02 / The Behemoth
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-ink leading-tight">
              The Original<br />Biggies Beast
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Double flame-grilled patties, smoked barbecue glaze,
              melted cheddar cheese, and crisp greens inside toasted sesame milk buns.
            </p>
