      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-4 border-b border-white/10">
          <div>
            <h2 className="type-display text-4xl sm:text-6xl md:text-7xl text-white font-black leading-tight tracking-tight">
              <ShinyText text="THE 450°F STEEL SMASH STANDARD." speed={3} shimmerColor="#2563EB" className="font-black" />
            </h2>
          </div>
                ...
                return (
                  ...
                  >
                    <span
                      ...
                      style={{ color: isSelected ? "#2563EB" : "#FAF8F2" }}
                    >
                      {p.number} // {p.title}
                    </span>
                    <span
                      ...
                      style={{
                        ...
                        color: isSelected ? "#2563EB" : "#A8A29E",
                ...
                <div className="lg:col-span-7 relative min-h-[340px] sm:min-h-[380px] rounded-2xl overflow-hidden border border-white/15 bg-black/60 group">
                  ...
                  {activeHotspot !== null && current.hotspots[activeHotspot] && (
                    <div
                      ...
                      style={{ borderColor: "#2563EB40", color: "#2563EB" }}
                    >
                      ...
                      <div key={sIdx} className="space-y-1">
                        ...
                        <div className="w-full h-1.5 rounded-full bg-white/10 overflow-hidden">
                          <div
                            ...
                            style={{ width: `${st.progress}%`, backgroundColor: "#2563EB" }}
                          />
                        </div>
                      </div>
                    ))}
        ...
        {viewMode === "compare" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <span className="font-sans text-xs font-bold uppercase tracking-wider block" style={{ color: "#2563EB" }}>
                OUR CRAFT SPEC
              </span>
