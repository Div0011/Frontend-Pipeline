      ...
      <div className="h-full max-w-[88rem] mx-auto px-6 lg:px-8">
        ...
        >
          <div className="space-y-6 max-w-3xl">
            <p className="type-caption text-[#2563EB] font-mono tracking-widest font-bold">
              Downtown Austin&apos;s Iconic Walk-Up Burger Window · 208 Congress Ave
            </p>
            <h1 className="type-display text-5xl sm:text-7xl lg:text-8xl xl:text-[6.5rem] leading-[0.88] tracking-tight text-ink">
              Congress Ave
              <br />
              <span className="text-[#2563EB]">Flat-Top Smashes</span>
            </h1>
            <p className="type-serif text-lg sm:text-xl md:text-2xl text-stone max-w-xl leading-relaxed">
              100% fresh Texas Angus flat-top burgers, Shiner Bock battered onion rings,
              and Fredericksburg peach shakes served hot from our downtown walk-up window.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                href="/menu"
                className="group inline-flex items-center gap-3 bg-[#2563EB] text-white px-8 py-4 type-caption text-xs hover:bg-[#F59E0B] hover:text-black transition-colors duration-500 shadow-xl"
              >
                Explore Walk-Up Menu
                <span className="group-hover:translate-x-1 transition-transform duration-300">→</span>
              </Link>
              <Link
                href="/locations"
                className="inline-flex items-center gap-3 border border-ink/30 text-ink px-8 py-4 type-caption text-xs hover:border-[#2563EB] hover:bg-[#2563EB] hover:text-white transition-all duration-500"
              >
                Congress Ave Window
              </Link>
            </div>
        ...
        >
          <div className="space-y-6 max-w-2xl">
            <p className="type-caption text-[#2563EB] font-mono tracking-widest font-bold">
              Phase 01 / Flat-Top Sizzle
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-ink leading-tight">
              Sizzling Texas<br />Angus Beef
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Pressed onto seasoned steel griddles right before your eyes,
              delivering a fast, juicy downtown lunch that never disappoints.
            </p>
            <div className="flex items-center gap-4 text-xs font-mono text-stone">
              ...
              <span>DOWNTOWN KINETICS SEQUENCE</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="space-y-6 max-w-xl text-left lg:text-right flex flex-col items-start lg:items-end w-full">
            <p className="type-caption text-[#2563EB] font-mono tracking-widest font-bold">
              Phase 02 / The Congress Double
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-ink leading-tight">
              The Congress<br />Double Stack
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Double Angus patties, melted sharp cheddar, Congress secret sauce, and Shiner rings.
            </p>
