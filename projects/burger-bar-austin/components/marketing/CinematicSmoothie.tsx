              ...
              {HOTSPOTS.map((spot) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* Pulse Ring */}
                      <span className="animate-ping absolute inline-flex h-6 w-6 rounded-full bg-[#2563EB] opacity-75"></span>
                      
                      {/* Core Dot */}
                      <span className="relative inline-flex rounded-full h-3 w-3 bg-[#2563EB] border border-char"></span>
                      ...
                      <AnimatePresence>
                        {isHovered && (
                          ...
                          >
                            <p className="type-caption text-[#2563EB] text-[10px] mb-1">{spot.label}</p>
