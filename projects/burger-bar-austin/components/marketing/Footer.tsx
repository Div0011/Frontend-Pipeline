...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "Instagram", handle: "@burger-bar-austin", link: "https://instagram.com", icon: "📸" },
    { name: "Twitter / X", handle: "@BURGERBARONCONGRESSHQ", link: "https://x.com", icon: "⚡" },
    { name: "TikTok", handle: "@burger-bar-austin", link: "https://tiktok.com", icon: "🔥" },
    { name: "YouTube", handle: "Burger Bar on Congress Media", link: "https://youtube.com", icon: "🎬" },
  ];
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <React.Fragment key={i}>
              <span className="flex items-center gap-2" style={{ color: "#2563EB" }}>
                ...
                BURGER BAR ON CONGRESS // CONGRESS AVENUE STREET SMASH
              </span>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-20 py-20 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-sm text-stone-300 max-w-md leading-relaxed font-body">
              DOWNTOWN AUSTIN WALK-UP FLAT TOP. Dedicated to artisanal craftsmanship, uncompromised ingredients, high-heat sears, and memorable culinary hospitality.
            </p>
        ...
        <div className="relative pt-12 border-t border-white/10 flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="w-full pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-mono text-stone-400">
            <p>© {new Date().getFullYear()} Burger Bar on Congress. All rights reserved.</p>
