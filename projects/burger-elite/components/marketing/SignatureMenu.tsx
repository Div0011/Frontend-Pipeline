        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 pb-6 border-b border-white/10">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider bg-[#7C3AED] text-black hover:brightness-110 active:scale-95 transition-all shadow-xl"
            >
            ...
            return (
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-xs uppercase tracking-wider font-bold transition-all whitespace-nowrap border ${
                  isSelected
                    ? "bg-[#7C3AED] text-black border-[#7C3AED] shadow-lg scale-105"
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span className="text-sm font-extrabold px-3 py-1 rounded-full border border-[#7C3AED]/40 text-[#7C3AED] bg-[#7C3AED]/10 whitespace-nowrap shadow-sm">
                      ₹{item.price}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-5 mt-4 border-t border-white/10">
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider bg-[#7C3AED] text-black hover:brightness-110 active:scale-95 transition-all shadow-md flex items-center gap-1 ml-auto"
                  >
                    <span>Add</span>
                    <span>+</span>
                  </button>
            ...
            >
              ...
              <div className="flex gap-4 pt-4 border-t border-white/10">
                <button
                  ...
                  className="w-full py-3 rounded-full text-xs font-bold uppercase tracking-widest bg-[#7C3AED] text-black hover:brightness-110 active:scale-95 transition-all shadow-xl"
                >
