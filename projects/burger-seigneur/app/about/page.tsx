...
export const metadata: Metadata = {
  title: "Our Story | BURGER SEIGNEUR",
  description: "The story behind BURGER SEIGNEUR — from humble beginnings to Bangalore's most iconic burger kitchen.",
};
          ...
          <div className="mx-auto max-w-[88rem] px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="type-serif text-xl text-stone leading-relaxed mb-6">
                BURGER SEIGNEUR started with a simple idea: to bring world-class smashburgers to Bangalore. But we didn&apos;t just want to open a restaurant — we wanted to build a brand in full view of our community.
              </p>
          ...
          <div className="mx-auto max-w-[88rem] px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="type-serif text-xl text-stone leading-relaxed">
                Every BURGER SEIGNEUR burger is a testament to our obsession with quality. We source the finest ingredients, perfect our techniques through countless iterations, and never compromise on the final product.
              </p>
            </div>
          </div>
        </section>
