    ...
    <section className="py-24 px-6 sm:px-12 md:px-20 bg-transparent text-white border-b border-white/10 relative z-10">
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="flex items-center gap-3">
          <span className="h-[1px] w-12" style={{ backgroundColor: "#C8A96E" }} />
          <span className="font-mono text-xs tracking-widest uppercase font-bold" style={{ color: "#C8A96E" }}>
            <DecryptedText
              text="THE SEIGNEUR ATELIER // LUXURY BRIOCHE SPEC"
              speed={40}
              maxIterations={12}
              animateOn="view"
            />
        ...
        <FadeContent blur={false} duration={0.9}>
          <div className="space-y-4">
            <h2 className="type-display text-3xl sm:text-5xl md:text-6xl text-bone leading-tight">
              ...
              <ShinyText
                text="ARTISANAL EUROPEAN GOURMET CRUST"
                speed={3}
                shimmerColor="#C8A96E"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <SpotlightCard
            spotlightColor="#C8A96E25"
            className="hover:border-white/40"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#C8A96E" }}>01 // HEAVY STEEL SMASH</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#C8A96E15", color: "#C8A96E", borderColor: "#C8A96E30" }}>
                  450°F
                </span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#C8A96E" }}>02 // SQUISHY POTATO BUNS</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#C8A96E15", color: "#C8A96E", borderColor: "#C8A96E30" }}>
                  GOLDEN
                </span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#C8A96E" }}>03 // CRAFT DIPS &amp; SHAKES</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#C8A96E15", color: "#C8A96E", borderColor: "#C8A96E30" }}>
                  HAND-SPUN
                </span>
              </div>
