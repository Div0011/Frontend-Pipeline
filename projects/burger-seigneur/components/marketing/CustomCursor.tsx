...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      ...
      const isMustardBg = (r > 150 && g > 100 && g < 180 && b < 60) || !!el.closest("[data-on-mustard], [style*='#C68A14'], .bg-\\[\\#C68A14\\], footer[style*='#C68A14'], footer[style*='#F5A623'], footer[style*='#418043']");
