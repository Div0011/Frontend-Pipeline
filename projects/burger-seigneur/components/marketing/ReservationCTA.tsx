    ...
    >
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        {confirmed ? (
          ...
          >
            <div className="w-16 h-16 rounded-full mx-auto flex items-center justify-center text-black" style={{ backgroundColor: "#C8A96E" }}>
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <div className="space-y-1">
              <span className="text-xs uppercase tracking-widest font-bold block" style={{ color: "#C8A96E" }}>
              ...
              <p className="text-stone-300 text-xs font-medium">
                Ref Code: <span className="font-bold" style={{ color: "#C8A96E" }}>{bookingRef}</span>
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-black/40 border border-white/10 space-y-2 text-left text-xs">
              ...
              <div className="flex justify-between text-stone-300">
                <span>Time:</span>
                <span className="font-bold" style={{ color: "#C8A96E" }}>{selectedTime}</span>
              </div>
              <div className="flex justify-between text-stone-300">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full py-4 rounded-xl text-xs font-bold uppercase tracking-widest bg-[#C8A96E] text-black hover:brightness-110 active:scale-95 transition-all shadow-2xl flex items-center justify-center gap-2"
            >
