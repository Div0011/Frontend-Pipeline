            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 flex flex-col justify-between shadow-2xl space-y-6">
              <div className="space-y-5">
                <div className="space-y-1.5">
                  <span className="font-mono text-[10px] tracking-widest uppercase font-bold block" style={{ color: "#C8A96E" }}>
                    OUTPOST DETAILS
                  </span>
                  ...
                  <p className="font-mono text-xs font-bold" style={{ color: "#C8A96E" }}>
                    {currentLoc.city}
                  </p>
                </div>
