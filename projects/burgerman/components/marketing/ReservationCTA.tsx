    ...
    >
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-3">
          <span className="font-mono text-xs tracking-widest uppercase font-bold block" style={{ color: "#15803D" }}>
            BURGERMAN TABLE RESERVATIONS
          </span>
        ...
        {confirmed ? (
          ...
          >
            ...
            <div className="space-y-1">
              <span className="font-mono text-xs uppercase tracking-widest font-bold" style={{ color: "#15803D" }}>
              ...
              <p className="font-mono text-xs text-stone-300">
                Booking Reference: <span className="font-bold" style={{ color: "#15803D" }}>{bookingRef}</span>
              </p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4 bg-white/5 p-3 rounded-xl border border-white/10 justify-between">
                  ...
                  <div className="text-center font-mono">
                    <span className="text-2xl font-bold" style={{ color: "#15803D" }}>{guestCount}</span>
