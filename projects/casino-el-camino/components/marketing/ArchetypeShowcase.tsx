      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-white/10 pb-6">
          ...
          <span className="font-mono text-xs text-stone-400">
            OPEN UNTIL 2:00 AM · 6th Street Austin
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-2">
            ...
            <p className="type-display text-3xl font-bold" style={{ color: "#DC2626" }}>TILL 2:00 AM</p>
            <p className="text-xs text-stone-400">Serving midnight cravings across 6th Street Austin every night.</p>
          </div>
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-2">
