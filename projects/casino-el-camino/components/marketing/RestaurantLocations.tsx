      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 border-b border-white/10 pb-8">
          <div className="space-y-2">
            <span className="font-sans text-xs tracking-widest uppercase block font-bold" style={{ color: "#DC2626" }}>
              CASINO EL CAMINO
            </span>
            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 flex flex-col justify-between shadow-2xl space-y-6">
              <div className="space-y-5">
                <div className="space-y-1.5">
                  <span className="font-sans text-[10px] tracking-widest uppercase font-bold block" style={{ color: "#DC2626" }}>
                    OUTPOST DETAILS
                  </span>
                  ...
                  <p className="font-sans text-xs font-bold" style={{ color: "#DC2626" }}>
                    {currentLoc.city}
                  </p>
                </div>
