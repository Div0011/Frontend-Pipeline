      ...
      <div className="max-w-[88rem] mx-auto px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="flex flex-wrap gap-3">
              {SOCIAL.map((s) => (
                <a
                  ...
                  className="type-label text-smoke text-[9px] hover:text-[#D97706] transition-colors duration-300 border border-char-mute px-3 py-2"
                >
                  {s.label}
                </a>
              ))}
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            <h3 className="type-caption text-[#D97706] text-[10px] mb-5 font-bold">Navigate</h3>
          ...
          <div className="lg:col-span-5">
            <h3 className="type-caption text-[#D97706] text-[10px] mb-5 font-bold">Our 4 Austin Area Stores</h3>
              ...
              {LOCATIONS.map((loc) => (
                <div key={loc.name}>
                  ...
                  <a
                    ...
                    className="type-label text-[#D97706] text-[9px] hover:underline transition-colors duration-300 mt-1 block font-bold"
                  >
                    {loc.phone}
                  </a>
                </div>
        ...
        <div className="mt-16 pt-8 border-t border-char-mute flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-6">
            <Link href="/privacy" className="type-label text-smoke text-[9px] hover:text-[#D97706] transition-colors duration-300">
              Privacy Policy
            </Link>
            <Link href="/terms" className="type-label text-smoke text-[9px] hover:text-[#D97706] transition-colors duration-300">
              Terms
            </Link>
            <a href="mailto:info@dans-hamburgers.com" className="type-label text-smoke text-[9px] hover:text-[#D97706] transition-colors duration-300">
