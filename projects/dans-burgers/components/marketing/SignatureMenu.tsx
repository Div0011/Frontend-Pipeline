          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                style={{
                  backgroundColor: isSelected ? "#D97706" : "rgba(255,255,255,0.05)",
                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-0.5">
                      <span className="text-[10px] uppercase tracking-wider font-bold" style={{ color: "#D97706" }}>
                        Item 0{idx + 1}
                      </span>
        ...
        {activePreviewItem && (
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                <span className="text-xs tracking-widest uppercase font-bold block" style={{ color: "#D97706" }}>
                  CULINARY SPEC
                </span>
