      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4 border-b border-[#C68A14]/25 pb-6">
          <div>
            ...
            <h2 className="type-display text-4xl sm:text-5xl text-[#C68A14] font-extrabold mt-1 tracking-tight">
            ...
            return (
              <motion.button
                ...
                style={{
                  ...
                  borderColor: isSelected ? "#C68A14" : "rgba(255,255,255,0.1)",
                }}
              >
                <div className="flex items-center justify-between">
                  <span
                    className="font-bold text-xs uppercase tracking-wider"
                    style={{ color: isSelected ? "#C68A14" : "#FAF8F2" }}
                  >
                    {p.number}. {p.title}
                  </span>
                  <span
          ...
          >
            ...
            <div className="lg:col-span-5 space-y-6">
              <div>
                ...
                <h3 className="type-display text-3xl text-[#C68A14] font-black leading-tight mt-1">
                  {current.title}
                </h3>
              </div>
