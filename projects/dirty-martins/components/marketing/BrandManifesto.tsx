        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-4 border-b border-white/10">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <span className="h-[2px] w-10" style={{ backgroundColor: "#BF5700" }} />
              <span className="font-mono text-xs tracking-widest uppercase font-bold" style={{ color: "#BF5700" }}>
                <DecryptedText
                  text="SINCE 1926 · 100 YEARS ON THE DRAG · AUSTIN"
                  speed={35}
                  maxIterations={10}
                  animateOn="view"
                />
            ...
            <h2 className="type-display text-3xl sm:text-5xl md:text-6xl text-white font-extrabold leading-tight">
              ...
              WE BELIEVE IN THE 
              <ShinyText
                text="CENTENNIAL KUM-BAK CHILI CRUST"
                speed={3}
                shimmerColor="#BF5700"
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      borderColor: isSelected ? "#BF5700" : "rgba(255,255,255,0.1)",
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <span
                        className="font-mono text-xs font-extrabold tracking-widest"
                        style={{ color: isSelected ? "#BF5700" : "#A8A29E" }}
                      >
                        {p.number} // {p.title}
                      </span>
                      <span
                        ...
                        style={{
                          ...
                          color: isSelected ? "#BF5700" : "#D6D3D1",
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-white/10 text-[11px] font-mono">
                      <span className="font-mono text-xs" style={{ color: isSelected ? "#BF5700" : "#78716C", fontWeight: isSelected ? 700 : 400 }}>
              ...
              >
                ...
                <div className="lg:col-span-7 relative min-h-[380px] sm:min-h-[440px] rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-black/60 group">
                  ...
                  {current.hotspots.map((h, hIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span className="w-2.5 h-2.5 rounded-full animate-ping absolute inset-0 m-auto opacity-75" style={{ backgroundColor: "#BF5700" }} />
                          <span>{hIdx + 1}</span>
                        </button>
                      </div>
                    );
                  ...
                  {activeHotspot !== null && current.hotspots[activeHotspot] && (
                    ...
                    >
                      <div className="flex items-center gap-2 font-mono text-xs font-bold uppercase tracking-wider" style={{ color: "#BF5700" }}>
        ...
        {viewMode === "compare" && (
          ...
          >
            ...
            <div
              ...
              style={{
                borderColor: "#BF570060",
              }}
            >
              <div className="flex items-center justify-between">
                <span className="font-mono text-xs font-bold uppercase tracking-wider flex items-center gap-2" style={{ color: "#BF5700" }}>
                  <span className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: "#BF5700" }} />
                  DIRTY MARTIN'S KUM-BAK STANDARD
                </span>
                <span className="font-mono text-[10px] font-bold px-2 py-0.5 rounded" style={{ backgroundColor: "#BF5700", color: "#FFFFFF" }}>
                  CRAFT SPEC
                </span>
              </div>
              <h3 className="type-display text-2xl sm:text-3xl text-white font-bold">
                DUAL LACY DIRTY MARTIN'S KUM-BAK SMASH
              </h3>
              <ul className="space-y-3 font-mono text-xs text-stone-200">
                <li className="flex items-start gap-2">
                  <span className="font-bold" style={{ color: "#BF5700" }}>✓</span>
