      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        {confirmed ? (
          <motion.div
            ...
            style={{ borderColor: "#BF5700" }}
          >
            <div className="w-16 h-16 rounded-full mx-auto flex items-center justify-center text-black" style={{ backgroundColor: "#BF5700" }}>
            ...
            <div className="space-y-1">
              ...
              <p className="text-stone-300 text-xs font-medium">
                Ref Code: <span className="font-bold" style={{ color: "#BF5700" }}>{bookingRef}</span>
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-black/40 border border-white/10 space-y-2 text-left text-xs">
              ...
              <div className="flex justify-between text-stone-300">
                <span>Time:</span>
                <span className="font-bold" style={{ color: "#BF5700" }}>{selectedTime}</span>
              </div>
              <div className="flex justify-between text-stone-300">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full py-4 rounded-xl text-xs font-bold uppercase tracking-widest bg-[#BF5700] text-black hover:brightness-110 active:scale-95 transition-all shadow-2xl flex items-center justify-center gap-2"
            >
