...
const menuItems = [
  {
    "id": "dh-burger",
    "name": "The Famous DH Special",
    "category": "Historic Burgers",
    "price": "8.75",
    "badge": "1926 Classic",
  ...
  {
    "id": "ot-special",
    "name": "O.T. Special Double Burger",
    "category": "Historic Burgers",
    "price": "10.50",
    "badge": "Crowd Pick",
...
export default function SignatureMenu() {
  ...
  return (
    <section id="menu-section" className="py-24 px-6 sm:px-12 md:px-20 bg-transparent text-black border-b border-[#C68A14]/25 relative z-10 font-sans">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-2 bg-[#FAF8F2] p-1.5 rounded-full border border-[#C68A14]/25">
            {categories.map((cat: any) => (
              <button
                ...
                style={{
                  backgroundColor: selectedCategory === cat ? "#C68A14" : "transparent",
                }}
              >
                {cat}
              </button>
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span className="font-mono font-bold text-xs px-2.5 py-1 rounded-full bg-[#FAF8F2] border border-[#C68A14]/25 text-black">
                    ${item.price}
                  </span>
                  <button
                    type="button"
        ...
        {activeItemModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white backdrop-blur-md">
            <motion.div
              ...
              className="relative w-full max-w-lg rounded-3xl bg-[#0e0f14] border border-[#C68A14]/25 p-6 sm:p-8 space-y-6 shadow-2xl text-black"
            >
              <button
                type="button"
                onClick={() => setActiveItemModal(null)}
                className="absolute top-4 right-4 w-9 h-9 rounded-full bg-[#FAF8F2] hover:bg-white/20 flex items-center justify-center text-black"
              >
                ✕
              </button>
