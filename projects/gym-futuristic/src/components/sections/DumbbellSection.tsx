...
export default function DumbbellSection() {
    ...
    <div className="absolute inset-0 flex items-center pt-20 pb-10">
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-12 md:px-20 relative overflow-visible">
        ...
        <div className="max-w-2xl">
          ...
          >
            Machined to 0.01mm tolerance. Micro-textured grip crafted from aerospace-grade alloy for unmatched tactile control.
          </p>
          <div ref={spec1} style={ts} className="mt-3 flex flex-wrap gap-6 font-mono-label text-[0.6rem] text-white/40">
            <span>WEIGHT: VAR. 5-50KG</span>
            <span>BALANCE: 99.98%</span>
          </div>
        </div>
        ...
        <div className="max-w-2xl mt-2">
          ...
          <p
            ...
            className="mt-3 text-xs sm:text-sm font-light leading-relaxed max-w-md"
          >
            Eliminating rotational drag. Balanced mass distribution ensures optimal load vectors throughout full range of motion.
          </p>
          <div ref={spec2} style={ts} className="mt-3 flex flex-wrap gap-6 font-mono-label text-[0.6rem] text-white/40">
            <span>ROTATION: LEVITATIONAL SCULPT</span>
            <span>SURFACE: MONOCHROME ANODIZED</span>
          </div>
        </div>
        ...
        <div className="max-w-2xl ml-auto text-right mt-2">
          ...
          >
            Built for athletes who refuse baseline limits. A seamless fusion of structural weight and minimal aesthetic purity.
          </p>
          <div ref={spec3} style={ts} className="mt-3 flex flex-wrap justify-end gap-6 font-mono-label text-[0.6rem] text-white/40">
            <span>OS: FORGE DYNAMICS v4</span>
  ...
  return (
    <section>
      <VS
        ...
        poster="/videos/dumbbell-poster.jpg"
        bgColor="#6b6f76"
