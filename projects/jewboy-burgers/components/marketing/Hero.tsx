        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              SHALOM Y&apos;ALL!
              <br />
              <span className="text-ember">JEWBOY BURGERS</span>
            </h1>
            ...
            >
              Smashed Angus chuck with grilled onions, crispy potato latkes, Hatch green chile queso, and warm El Paso border hospitality on Airport Blvd.
            </p>

            <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                href="/menu"
                className="btn-yolk text-xs shadow-xl font-bold"
              >
                Border Menu →
              </Link>
              <Link
          ...
          <div className="lg:col-span-5 relative">
            ...
            >
              <p className="type-caption text-ember text-xs mb-2 font-bold">Est. 2020</p>
              <p className="type-serif text-lg text-char font-bold">Airport Blvd · Austin, TX</p>
            </motion.div>
          </div>
        </div>
      </div>
