    ...
    >
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-3">
          <span className="font-sans text-xs tracking-widest uppercase font-bold block" style={{ color: "#06B6D4" }}>
            JEWBOY BURGERS
          </span>
        ...
        {confirmed ? (
          ...
          >
            ...
            <div className="space-y-1">
              <span className="font-sans text-xs uppercase tracking-widest font-bold" style={{ color: "#06B6D4" }}>
