  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="font-bold">OPEN DAILY: 11:00 AM – 1:00 AM</p>
      ...
      >
        <div className="space-y-1" style={{ color: "#00000099" }}>
          ...
          <p>Indiranagar, Frazer Town & Whitefield, Bengaluru</p>
          <p>orders@leonsgrill.in</p>
        </div>

        <div className="flex items-center justify-between sm:justify-end gap-8">
          <p className="font-medium" style={{ color: "#00000066" }}>
            © {new Date().getFullYear()} LEON'S BURGERS
          </p>
          <button
            type="button"
            onClick={scrollToTop}
