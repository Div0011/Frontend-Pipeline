      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="font-sans text-xs uppercase tracking-wider font-bold" style={{ color: "#B12727" }}>
            ...
            <div className="flex items-center gap-3">
              <span className="font-sans text-3xl font-black" style={{ color: "#B12727" }}>
                {tempValue}°F
              </span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs font-sans text-stone-400 font-semibold">
              <span>250°F (Low)</span>
              <span style={{ color: "#B12727" }}>450°F (Optimal Craft)</span>
              <span>500°F (Max)</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans">
          <div className="p-6 rounded-2xl bg-white/[0.03] backdrop-blur-md border border-white/10 space-y-2">
            <span className="font-bold text-xs uppercase tracking-wider block" style={{ color: "#B12727" }}>
              01. Stage
            </span>
