      ...
      <div className="mx-auto max-w-[88rem] px-6 lg:px-8">
        ...
        >
          {timelineEvents.map((event, idx) => (
            ...
            >
              <div className="flex justify-between items-center text-[10px] font-sans tracking-widest text-mist">
        ...
        <div className="mt-12 flex items-center justify-between gap-8">
          ...
          <div className="font-sans text-[10px] text-mist tracking-widest flex-shrink-0">
