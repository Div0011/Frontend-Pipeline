      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
            <span className="type-display text-4xl font-black" style={{ color: "#166534" }}>48 Hours</span>
            <h4 className="font-sans font-bold text-sm uppercase text-white">COLD DOUGH FERMENTATION</h4>
            <p className="text-xs text-stone-400">Breaks down complex gluten structures for an ultra-light, airy, crisp crumb.</p>
          </div>
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
            <span className="type-display text-4xl font-black" style={{ color: "#166534" }}>650°F</span>
            <h4 className="font-sans font-bold text-sm uppercase text-white">REFRACTORY STONE DECK</h4>
            <p className="text-xs text-stone-400">Direct contact heat baking that produces intense bottom crunch &amp; leopard spots.</p>
          </div>
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
            <span className="type-display text-4xl font-black" style={{ color: "#166534" }}>100% D.O.P.</span>
            <h4 className="font-sans font-bold text-sm uppercase text-white">AUTHENTIC SAN MARZANO</h4>
