        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-4 border-b border-white/10">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <span className="h-[2px] w-10" style={{ backgroundColor: "#166534" }} />
              <span className="font-mono text-xs tracking-widest uppercase font-bold" style={{ color: "#166534" }}>
                <DecryptedText
                  text="NJ STONE-BAKED PIES & PASTRAMI SUBS · CRESTVIEW"
                  speed={35}
                  maxIterations={10}
                  animateOn="view"
                />
            ...
            <h2 className="type-display text-3xl sm:text-5xl md:text-6xl text-white font-extrabold leading-tight">
              ...
              WE BELIEVE IN THE 
              <ShinyText
                text="ARTISAN STONE-BAKED NJ CRUST"
                speed={3}
                shimmerColor="#166534"
          ...
          <div className="flex items-center gap-2 p-1.5 rounded-full bg-white/5 border border-white/15 backdrop-blur-md self-start md:self-end">
            <button
              ...
              style={{
                backgroundColor: viewMode === "spec" ? "#166534" : "transparent",
            ...
            <button
              ...
              className="px-4 py-2 rounded-full font-mono text-xs font-bold uppercase tracking-wider transition-all"
              style={{
                backgroundColor: viewMode === "compare" ? "#166534" : "transparent",
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      borderColor: isSelected ? "#166534" : "rgba(255,255,255,0.1)",
                    }}
                  >
                    <div className="flex items-center justify-between">
                      <span
                        className="font-mono text-xs font-extrabold tracking-widest"
                        style={{ color: isSelected ? "#166534" : "#A8A29E" }}
                      >
                        {p.number} // {p.title}
                      </span>
                      <span
                        ...
                        style={{
                          backgroundColor: isSelected ? "#16653420" : "rgba(255,255,255,0.05)",
                          color: isSelected ? "#166534" : "#D6D3D1",
                          borderColor: isSelected ? "#16653440" : "rgba(255,255,255,0.1)",
                        }}
                      >
                        {p.badge}
                      </span>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-white/10 text-[11px] font-mono">
                      <span className="font-mono text-xs" style={{ color: isSelected ? "#166534" : "#78716C", fontWeight: isSelected ? 700 : 400 }}>
              ...
              >
                ...
                <div className="lg:col-span-7 relative min-h-[380px] sm:min-h-[440px] rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-black/60 group">
                  ...
                  {current.hotspots.map((h, hIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span className="w-2.5 h-2.5 rounded-full animate-ping absolute inset-0 m-auto opacity-75" style={{ backgroundColor: "#166534" }} />
                          <span>{hIdx + 1}</span>
                        </button>
                      </div>
                    );
                  ...
                  {activeHotspot !== null && current.hotspots[activeHotspot] && (
                    ...
                    >
                      <div className="flex items-center gap-2 font-mono text-xs font-bold uppercase tracking-wider" style={{ color: "#166534" }}>
                    ...
                    {current.stats.map((st, sIdx) => (
                      <div key={sIdx} className="space-y-1.5">
                        <div className="flex justify-between text-xs font-mono">
                          ...
                          <span className="font-bold" style={{ color: "#166534" }}>{st.value}</span>
                        </div>
        ...
        {viewMode === "compare" && (
          ...
          >
            ...
            <div
              ...
              style={{
                borderColor: "#16653460",
              }}
            >
              <div className="flex items-center justify-between">
                <span className="font-mono text-xs font-bold uppercase tracking-wider flex items-center gap-2" style={{ color: "#166534" }}>
                  <span className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: "#166534" }} />
                  ✅ LITTLE DELI & PIZZERIA STANDARD
                </span>
                <span className="font-mono text-[10px] font-bold px-2 py-0.5 rounded" style={{ backgroundColor: "#166534", color: "#FFFFFF" }}>
                  CRAFT SPEC
                </span>
              </div>
              <h3 className="type-display text-2xl sm:text-3xl text-white font-bold">
                LITTLE DELI & PIZZERIA WOOD-FIRED CRAFT
              </h3>
