          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <React.Fragment key={i}>
              <span className="flex items-center gap-2" style={{ color: "#166534" }}>
                <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: "#166534" }} />
                LITTLE DELI & PIZZERIA
              </span>
              <span>AUSTIN OUTPOSTS</span>
              <span className="text-white">CRAFT KITCHEN</span>
              <span style={{ color: "#166534" }}>ORDER ONLINE</span>
            </React.Fragment>
          ))}
        </motion.div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-20 py-20 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 p-8 rounded-3xl bg-white/[0.03] backdrop-blur-md border border-white/10 shadow-xl space-y-5">
            <div className="space-y-1">
              <span className="font-mono text-[10px] font-bold uppercase tracking-widest" style={{ color: "#166534" }}>
                NEWSLETTER // DROPS
              </span>
              ...
              {!isSubscribed ? (
                ...
                >
                  ...
                  <p className="font-mono text-xs text-stone-300">
                    Code <span className="px-1.5 py-0.5 rounded bg-emerald-400/20 text-emerald-200 font-bold tracking-widest">LITTLE15</span> for 15% off first order.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-white/10">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 pt-1 text-xs font-mono">
              ...
              >
                (512) 467-7402
                <span className="ml-2 text-[10px] px-1 py-0.5 rounded bg-white/10" style={{ color: "#166534" }}>
        ...
        <div className="relative pt-10 border-t border-white/10 flex flex-col items-center justify-center">
          ...
          <div className="w-full pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-mono text-stone-400">
            <p>© {new Date().getFullYear()} Little Deli & Pizzeria.</p>
            <p>AUSTIN</p>
          </div>
        </div>
      </div>
