      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="font-sans text-xs uppercase tracking-wider font-bold" style={{ color: "#166534" }}>
            ...
            <div className="flex items-center gap-3">
              <span className="font-sans text-3xl font-black" style={{ color: "#166534" }}>
                {tempValue}°F
              </span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs font-sans text-stone-400 font-semibold">
              <span>500°F (Low)</span>
              <span style={{ color: "#166534" }}>900°F (Optimal Craft)</span>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10 font-sans">
            <div className="p-4 rounded-xl bg-black/40 border border-white/10">
              <div className="flex justify-between text-xs font-semibold mb-2">
                ...
                <span className="font-bold" style={{ color: "#166534" }}>{crustPercent}%</span>
              </div>
              <div className="w-full bg-stone-800 h-1.5 rounded-full overflow-hidden">
                <div
                  className="h-full rounded-full transition-all duration-300"
                  style={{ width: `${crustPercent}%`, backgroundColor: "#166534" }}
                />
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-sans">
          <div className="p-6 rounded-2xl bg-white/[0.03] backdrop-blur-md border border-white/10 space-y-2">
            <span className="font-bold text-xs uppercase tracking-wider block" style={{ color: "#166534" }}>
              01. Stage
            </span>
