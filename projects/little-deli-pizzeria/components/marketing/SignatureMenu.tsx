...
const menuItems = [
  {
    "id": "jersey-shore",
    "name": "The Jersey Shore Sub",
    "category": "Hot Subs",
    "price": "13.50",
    "badge": "East Coast Classic",
    "image": "https://images.unsplash.com/photo-1509722747041-616f39b57569?w=800&q=80"
  },
  {
    "id": "white-pie",
    "name": "Brooklyn Style White Pie",
    "category": "Hearth Pizza",
    "price": "22.50",
    "badge": "Garlic Ricotta",
          ...
          <div className="flex flex-wrap items-center gap-2 bg-white/5 p-1.5 rounded-full border border-white/10">
            {categories.map((cat: any) => (
              <button
                ...
                style={{
                  backgroundColor: selectedCategory === cat ? "#166534" : "transparent",
                }}
              >
                {cat}
              </button>
          ...
          {filteredItems.map((item: any) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                <h3 className="type-display text-xl sm:text-2xl text-white font-bold leading-tight group-hover:text-[#166534] transition-colors">
                  {item.name}
                </h3>
