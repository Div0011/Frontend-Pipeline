          ...
          <div className="lg:col-span-5 lg:col-start-2">
            ...
            <div className="space-y-6">
              ...
              <p className="type-body text-stone">
                Each LOUIS BURGER patty is smashed at precisely 230°C on a cast-iron griddle. The result is a caramelized crust that gives way to a juicy, flavorful interior.
              </p>
            </div>
            <Link
              href="/about"
    ...
    <section ref={ref} className="section-cinematic bg-cream relative overflow-hidden border-t border-ink/5">
      ...
      <div className="relative z-10 mx-auto max-w-[88rem] px-6 lg:px-8 text-center">
        ...
        <p className="type-serif text-xl text-stone max-w-2xl mx-auto mb-12 leading-relaxed">
          Join us for an unforgettable dining experience. Reserve your table and discover why LOUIS BURGER is Bangalore&apos;s premier burger kitchen.
        </p>
              ...
              {!reserved ? (
                ...
                <div className="text-center py-8 space-y-4">
                  ...
                  <p className="type-serif text-stone">
                    Your table at LOUIS BURGER Atelier has been reserved. A confirmation SMS has been dispatched.
                  </p>
                  <button
                    onClick={() => {
                      setReserved(false);
