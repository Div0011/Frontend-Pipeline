...
const menuItems = [
  {
    "id": "truffle-burger",
    "name": "Truffle Shroom Swiss Burger",
    "category": "Artisanal Burgers",
    "price": "495",
    "badge": "Chef Zorawar Pick",
    "image": "https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=800&q=80"
  },
  {
    "id": "monster-cheese",
    "name": "Monster Double Cheese",
    "category": "Artisanal Burgers",
    "price": "525",
    "badge": "Gold Standard",
          ...
          {filteredItems.map((item: any) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                <h3 className="type-display text-xl sm:text-2xl text-white font-bold leading-tight group-hover:text-[#D4AF37] transition-colors">
                  {item.name}
                </h3>
