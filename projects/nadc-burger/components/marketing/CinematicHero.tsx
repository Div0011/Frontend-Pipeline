      ...
      <div className="h-full max-w-[88rem] mx-auto px-6 lg:px-8">
        ...
        >
          <div className="space-y-6 max-w-3xl">
            <p className="type-caption text-white/80 font-mono tracking-widest font-bold">
              Philip Speer &amp; Neen Williams · East 6th Street Austin
            </p>
            <h1 className="type-display text-5xl sm:text-7xl lg:text-8xl xl:text-[6.5rem] leading-[0.88] tracking-tight text-white">
              Not A Damn
              <br />
            ...
            <p className="type-serif text-lg sm:text-xl md:text-2xl text-stone max-w-xl leading-relaxed">
              100% Texas HeartBrand Akaushi Wagyu beef smashed on high-heat cast iron,
              American cheese, secret sauce, pickles, and Martin&apos;s Famous Potato Rolls with beef tallow fries.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                href="/menu"
                className="group inline-flex items-center gap-3 bg-white text-black px-8 py-4 type-caption text-xs hover:bg-stone-300 hover:text-black transition-colors duration-500 shadow-xl"
              >
                Explore Wagyu Menu
              ...
              <Link
                href="/locations"
                className="inline-flex items-center gap-3 border border-white/40 text-white px-8 py-4 type-caption text-xs hover:border-white hover:bg-white hover:text-black transition-all duration-500"
              >
                East 6th Location
              </Link>
            </div>
        ...
        >
          <div className="space-y-6 max-w-2xl">
            <p className="type-caption text-white/80 font-mono tracking-widest font-bold">
              Phase 01 / Akaushi Wagyu Sear
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-white leading-tight">
              100% Texas<br />HeartBrand Wagyu
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Heavily marbled Wagyu fat renders instantly on cast iron, creating an unrivaled
              caramelized crust that melts in your mouth.
            </p>
            <div className="flex items-center gap-4 text-xs font-mono text-stone">
              ...
              <span>AKAUSHI KINETICS SEQUENCE</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="space-y-6 max-w-xl text-left lg:text-right flex flex-col items-start lg:items-end w-full">
            <p className="type-caption text-white/80 font-mono tracking-widest font-bold">
              Phase 02 / The One True Burger
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-white leading-tight">
              The NADC<br />Masterpiece
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Martin&apos;s Potato Roll, molten American cheese, secret sauce, pickles, and pure Wagyu perfection.
            </p>
