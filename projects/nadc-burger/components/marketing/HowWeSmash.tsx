      ...
      <div className="max-w-6xl mx-auto space-y-14">
        ...
        <div className="p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span className="font-mono text-[10px] uppercase tracking-wider font-bold" style={{ color: "#FFFFFF" }}>
            ...
            <div className="flex items-center gap-3">
              <span className="font-mono text-3xl font-black" style={{ color: "#FFFFFF" }}>
                {tempValue}°F
              </span>
              <span
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-[10px] font-mono text-stone-400">
              ...
              <span className="font-bold" style={{ color: "#FFFFFF" }}>450°F (Optimal Crisp Sear)</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="space-y-1.5 p-4 rounded-xl bg-black/40 border border-white/10">
              <div className="flex justify-between text-xs font-mono">
                ...
                <span className="font-bold" style={{ color: "#FFFFFF" }}>{crustPercent}%</span>
              </div>
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <motion.div
                  className="h-full"
                  style={{ width: `${crustPercent}%`, backgroundColor: "#FFFFFF" }}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5 p-4 rounded-xl bg-black/40 border border-white/10">
              ...
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <motion.div
                  className="h-full"
                  style={{ width: `${tempValue >= 440 ? 98 : 75}%`, backgroundColor: "#FFFFFF" }}
                />
              </div>
            </div>
          </div>
