      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 border-b border-white/10 pb-8">
          <div className="space-y-2">
            <span className="font-mono text-xs tracking-widest uppercase block font-bold" style={{ color: "#FFFFFF" }}>
              NADC BURGER // PHYSICAL OUTPOSTS
            </span>
            ...
            <div className="flex items-center gap-3 bg-white/5 p-1.5 rounded-full border border-white/10">
              {outposts.map((loc: any, idx: number) => (
                <button
                  ...
                  style={{
                    backgroundColor: selectedLocation === idx ? "#FFFFFF" : undefined,
                  ...
                  <div className="flex items-center gap-2">
                    {allImages.map((img: string, iIdx: number) => (
                      <button
                        ...
                        style={{
                          borderColor: activeImageIndex === iIdx ? "#FFFFFF" : undefined,
                        }}
                      >
            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-white/[0.04] backdrop-blur-md border border-white/15 flex flex-col justify-between shadow-2xl space-y-6">
              <div className="space-y-5">
                <div className="space-y-1.5">
                  <span className="font-mono text-[10px] tracking-widest uppercase font-bold block" style={{ color: "#FFFFFF" }}>
                    OUTPOST DETAILS
                  </span>
                  ...
                  <p className="font-mono text-xs font-bold" style={{ color: "#FFFFFF" }}>
                    {currentLoc.city}
                  </p>
                </div>
                ...
                <div className="space-y-2 text-xs font-mono text-stone-300 pt-2 border-t border-white/10">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold" style={{ color: "#FFFFFF" }}>{currentLoc.phone}</span>
                  </div>
                </div>
              </div>
