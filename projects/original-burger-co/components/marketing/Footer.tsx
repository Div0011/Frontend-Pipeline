  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="font-bold">OPEN DAILY: 12:00 PM – 11:30 PM</p>
      ...
      >
        <div className="space-y-1" style={{ color: "#00000099" }}>
          ...
          <p>Kammanahalli & Indiranagar, Bengaluru</p>
          <p>eat@originalburgerco.in</p>
        </div>

        <div className="flex items-center justify-between sm:justify-end gap-8">
          <p className="font-medium" style={{ color: "#00000066" }}>
            © {new Date().getFullYear()} ORIGINAL BURGER CO.
          </p>
          <button
            type="button"
            onClick={scrollToTop}
