    ...
    <section className="py-24 px-6 sm:px-12 md:px-20 bg-char text-bone border-b border-char-mute relative overflow-hidden">
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="flex items-center gap-3">
          <span className="h-[1px] w-12" style={{ backgroundColor: "#DC2626" }} />
          <span className="font-mono text-xs tracking-widest uppercase font-bold" style={{ color: "#DC2626" }}>
            <DecryptedText
              text="THE PEDROSO STANDARD // SLOW-FERMENT SPEC"
              speed={40}
              maxIterations={12}
              animateOn="view"
            />
        ...
        <FadeContent blur={false} duration={0.9}>
          <div className="space-y-4">
            <h2 className="type-display text-3xl sm:text-5xl md:text-6xl text-bone leading-tight">
              ...
              <ShinyText
                text="CRISPY BOTTOM ROMAN CRUST"
                speed={3}
                shimmerColor="#DC2626"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <SpotlightCard
            spotlightColor="#DC262625"
            className="hover:border-white/40"
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#DC2626" }}>01 // HEAVY STEEL SMASH</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#DC262615", color: "#DC2626", borderColor: "#DC262630" }}>
                  450°F
                </span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#DC2626" }}>02 // SQUISHY POTATO BUNS</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#DC262615", color: "#DC2626", borderColor: "#DC262630" }}>
                  GOLDEN
                </span>
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-mono text-sm font-bold" style={{ color: "#DC2626" }}>03 // CRAFT DIPS &amp; SHAKES</span>
                <span className="text-[10px] font-mono px-2 py-0.5 rounded border" style={{ backgroundColor: "#DC262615", color: "#DC2626", borderColor: "#DC262630" }}>
                  HAND-SPUN
                </span>
              </div>
