...
const menuItems = [
  {
    "id": "grandma-pie",
    "name": "Traditional Grandma Pie",
    "category": "Square Pies",
    "price": "26.00",
    "badge": "Award Winning",
  ...
  {
    "id": "ny-pepperoni",
    "name": "NY Style Hot Honey Pepperoni",
    "category": "Round Pies",
    "price": "24.00",
    "badge": "Cup & Char",
          ...
          <div className="flex flex-wrap items-center gap-2 bg-white/5 p-1.5 rounded-full border border-white/10">
            {categories.map((cat: any) => (
              <button
                ...
                style={{
                  backgroundColor: selectedCategory === cat ? "#D91C24" : "transparent",
                }}
              >
                {cat}
              </button>
          ...
          {filteredItems.map((item: any) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                <h3 className="type-display text-xl sm:text-2xl text-[#F2C777] font-bold leading-tight group-hover:text-[#D91C24] transition-colors">
                  {item.name}
                </h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <h3 className="type-display text-3xl font-black text-[#F2C777]">
                  {activeItemModal.name}
                </h3>
              </div>

              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <span className="type-display text-2xl font-bold text-[#F2C777]">
