          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-mono text-xs tracking-widest uppercase font-bold" style={{ color: "#B91C1C" }}>
                PEDROSO'S PIZZA SIGNATURE MENU
              </span>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      <span className="font-mono text-[9px] uppercase tracking-widest font-bold" style={{ color: "#B91C1C" }}>
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <div>
                  ...
                  <span className="font-mono text-2xl font-black" style={{ color: "#B91C1C" }}>
