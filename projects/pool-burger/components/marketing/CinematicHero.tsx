      ...
      <div className="h-full max-w-[88rem] mx-auto px-6 lg:px-8">
        ...
        >
          <div className="space-y-6 max-w-3xl">
            <p className="type-caption text-[#F43F5E] font-mono tracking-widest font-bold">
              1968 Airstream Trailer &amp; Tropical Tiki Bar · Deep Eddy Pool
            </p>
            <h1 className="type-display text-5xl sm:text-7xl lg:text-8xl xl:text-[6.5rem] leading-[0.88] tracking-tight text-ink">
              Tiki Drinks &amp;
              <br />
              <span className="text-[#F43F5E]">Deep Eddy Smashes</span>
            </h1>
            <p className="type-serif text-lg sm:text-xl md:text-2xl text-stone max-w-xl leading-relaxed">
              Grass-fed Texas beef smash burgers, crinkle-cut fries, and handcrafted Mai Tais
              served under palm trees overlooking Austin&apos;s historic Deep Eddy Pool.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                href="/menu"
                className="group inline-flex items-center gap-3 bg-[#F43F5E] text-white px-8 py-4 type-caption text-xs hover:bg-[#0D9488] hover:text-white transition-colors duration-500 shadow-xl"
              >
                Explore Tiki Menu
              ...
              <Link
                href="/locations"
                className="inline-flex items-center gap-3 border border-ink/30 text-ink px-8 py-4 type-caption text-xs hover:border-[#F43F5E] hover:bg-[#F43F5E] hover:text-white transition-all duration-500"
              >
                Deep Eddy Location
              </Link>
            </div>
        ...
        >
          <div className="space-y-6 max-w-2xl">
            <p className="type-caption text-[#F43F5E] font-mono tracking-widest font-bold">
              Phase 01 / Airstream Flat-Top
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-ink leading-tight">
              Smashed Grass-Fed<br />Texas Beef
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Pressed onto seasoned cast iron inside our vintage 1968 trailer,
              creating crispy lacy edges with pure Texas ranch flavor.
            </p>
            <div className="flex items-center gap-4 text-xs font-mono text-stone">
              ...
              <span>TIKI KINETICS SEQUENCE</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="space-y-6 max-w-xl text-left lg:text-right flex flex-col items-start lg:items-end w-full">
            <p className="type-caption text-[#F43F5E] font-mono tracking-widest font-bold">
              Phase 02 / The Deep End
            </p>
            <h2 className="type-display text-4xl sm:text-6xl text-ink leading-tight">
              The Deep End<br />Double
            </h2>
            <p className="type-serif text-lg sm:text-xl text-stone leading-relaxed">
              Charred pineapple, crispy bacon, Swiss cheese, jalapeño ranch, and double smash patties.
            </p>
