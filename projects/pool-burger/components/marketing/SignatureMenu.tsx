        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-8 pb-8 border-b border-white/10">
          <div className="space-y-2">
            <div className="flex items-center gap-2.5">
              <span className="w-2.5 h-2.5 rounded-full animate-ping" style={{ backgroundColor: "#F43F5E" }} />
              <span className="font-sans text-xs tracking-widest uppercase font-bold" style={{ color: "#F43F5E" }}>
                POOL BURGER
              </span>
            </div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="relative">
              <input
                ...
                style={{ borderColor: searchQuery ? "#F43F5E" : undefined }}
              />
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                style={{
                  backgroundColor: isSelected ? "#F43F5E" : undefined,
                  color: isSelected ? "#FFFFFF" : undefined,
                  borderColor: isSelected ? "#F43F5E" : undefined,
                }}
              >
                {cat.label}
              </button>
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      <span className="font-sans text-[9px] uppercase tracking-widest font-bold" style={{ color: "#F43F5E" }}>
                        POOL BURGER // #0{idx + 1}
                      </span>
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <div>
                  ...
                  <span className="font-sans text-2xl font-black" style={{ color: "#F43F5E" }}>
