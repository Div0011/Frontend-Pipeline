  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="font-bold">OPEN DAILY: 1:00 PM – 2:00 AM</p>
      ...
      >
        <div className="space-y-1" style={{ color: "#00000099" }}>
          ...
          <p>HSR Layout Sector 4 & Koramangala, Bengaluru</p>
          <p>orders@sankysburgers.in</p>
        </div>

        <div className="flex items-center justify-between sm:justify-end gap-8">
          <p className="font-medium" style={{ color: "#00000066" }}>
            © {new Date().getFullYear()} SANKY'S BURGER HOUSE
          </p>
          <button
            type="button"
            onClick={scrollToTop}
