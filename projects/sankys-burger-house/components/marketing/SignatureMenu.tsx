    ...
    >
      <div className="max-w-7xl mx-auto space-y-10 font-sans">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 pb-6 border-b border-white/10">
          <div>
            <span className="text-xs uppercase font-bold tracking-widest block" style={{ color: "#FFE500" }}>
              SIGNATURE MENU
            </span>
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                style={{
                  backgroundColor: isSelected ? "#FFE500" : "rgba(255,255,255,0.05)",
                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-0.5">
                      <span className="text-[10px] uppercase tracking-wider font-bold" style={{ color: "#FFE500" }}>
                        Item 0{idx + 1}
                      </span>
        ...
        {activePreviewItem && (
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                <span className="text-xs tracking-widest uppercase font-bold block" style={{ color: "#FFE500" }}>
                  CULINARY SPEC
                </span>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                <span className="text-2xl font-black" style={{ color: "#FFE500" }}>
