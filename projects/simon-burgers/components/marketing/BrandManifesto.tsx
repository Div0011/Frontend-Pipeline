                ...
                return (
                  <motion.div
                    ...
                    className={`p-5 rounded-2xl cursor-pointer transition-all backdrop-blur-xl border flex items-center justify-between shadow-xl ${
                      isSelected
                        ? "border-[#DC2626] bg-white/[0.08] [html.light_&]:bg-white [html.light_&]:border-[#DC2626]"
                  ...
                  >
                    <span
                      className={`font-sans text-xs font-extrabold tracking-wider ${
                        isSelected
                          ? "text-[#DC2626] [html.light_&]:text-stone-950"
                    ...
                    <span
                      ...
                      style={{
                        ...
                        color: isSelected ? "#DC2626" : undefined,
                    ...
                    {current.stats.map((st, sIdx) => (
                      <div key={sIdx} className="space-y-1">
                        <div className="flex justify-between text-xs font-semibold">
                          ...
                          <span className="font-bold [html.light_&]:text-stone-950" style={{ color: "#DC2626" }}>{st.value}</span>
                        </div>
        ...
        {viewMode === "compare" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-white/[0.04] [html.light_&]:bg-white/80 border border-white/15 [html.light_&]:border-black/10 backdrop-blur-xl shadow-2xl space-y-4">
              <span className="text-xs uppercase font-extrabold [html.light_&]:text-stone-950 block" style={{ color: "#DC2626" }}>
                OUR CAST-IRON SMASH
              </span>
