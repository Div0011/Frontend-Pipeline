...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "Instagram", handle: "@smash-guys", link: "https://instagram.com", icon: "📸" },
    { name: "Twitter / X", handle: "@SMASHGUYSHQ", link: "https://x.com", icon: "⚡" },
    { name: "TikTok", handle: "@smash-guys", link: "https://tiktok.com", icon: "🔥" },
    { name: "YouTube", handle: "Smash Guys Media", link: "https://youtube.com", icon: "🎬" },
  ];
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <React.Fragment key={i}>
              <span className="flex items-center gap-2" style={{ color: "#F5C418" }}>
                ...
                SMASH GUYS // MAXIMUM CRUNCH MAILLARD CRUST
              </span>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-20 py-20 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-sm text-stone-300 max-w-md leading-relaxed font-body">
              450°F CAST-IRON SMASHED BURGERS · BANGALORE. Dedicated to artisanal craftsmanship, uncompromised ingredients, high-heat sears, and memorable culinary hospitality.
            </p>
              ...
              {!isSubscribed ? (
                ...
                >
                  ...
                  <p className="font-mono text-xs text-stone-200">
                    Use code <span className="px-2 py-0.5 rounded bg-emerald-400/20 text-emerald-200 font-bold tracking-widest border border-emerald-400/40">SMASHG15</span> for 15% off your next visit.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
        ...
        <div className="relative pt-12 border-t border-white/10 flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="w-full pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-mono text-stone-400">
            <p>© {new Date().getFullYear()} Smash Guys. All rights reserved.</p>
