...
const LOCATIONS = [
  {
    ...
    "address": "948, 12th Main Rd, HAL 2nd Stage",
    "hours": "11am \u2013 11:30pm",
    "phone": "080 4736 2227"
  },
  {
    "name": "RMZ Ecoworld Bellandur",
    "address": "Ground Floor, RMZ Ecoworld Rd",
    "hours": "11am \u2013 11pm",
    "phone": "080 4736 2228"
  }
];
    ...
    <footer className="bg-char border-t border-char-mute">
      ...
      <div className="bg-yolk text-char px-6 lg:px-8 py-7 flex flex-col sm:flex-row items-center justify-between gap-4 max-w-full">
        <div className="flex items-center gap-4">
          <span className="type-display text-3xl text-char">CRAVING REAL SMASH BURGERS?</span>
          <span className="type-serif text-char/80 italic text-lg hidden sm:block">Visit Indiranagar or Ecoworld Bellandur, or order online.</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="type-display text-2xl text-bone">SMASH GUYS</span>
            </div>
            <p className="type-serif text-stone text-lg leading-relaxed mb-6 max-w-sm">
              Bangalore original smash burger kitchen. Double-smashed patties and cast-iron caramelized crust.
            </p>
