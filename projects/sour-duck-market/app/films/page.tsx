...
export const metadata: Metadata = {
  title: "Films | SOUR DUCK",
  description: "A curated series of visual stories capturing the craft, culture, and cinema of SOUR DUCK.",
};
          ...
          <div className="mx-auto max-w-[88rem] px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="type-serif text-xl text-stone leading-relaxed max-w-xl">
                A curated series where craft, cuisine, and cinema converge — each frame a chapter in the SOUR DUCK narrative.
              </p>
            </div>
          </div>
        </section>
