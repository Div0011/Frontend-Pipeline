      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
            <span className="type-display text-4xl font-black" style={{ color: "#EA580C" }}>36 Hours</span>
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
            <span className="type-display text-4xl font-black" style={{ color: "#EA580C" }}>Live Post Oak</span>
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-3">
            <span className="type-display text-4xl font-black" style={{ color: "#EA580C" }}>100% D.O.P.</span>
