  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="font-bold">OPEN DAILY: 9:00 AM – 9:00 PM</p>
          <p>EAST 12TH STREET</p>
        </div>
      </div>
      ...
      >
        <div className="space-y-1" style={{ color: "#00000099" }}>
          ...
          <p>1814 E 12th St, Austin, TX 78702</p>
          <p>hello@sourduckmarket.com</p>
        </div>

        <div className="flex items-center justify-between sm:justify-end gap-8">
          <p className="font-medium" style={{ color: "#00000066" }}>
            © {new Date().getFullYear()} SOUR DUCK MARKET
          </p>
          <button
            type="button"
            onClick={scrollToTop}
