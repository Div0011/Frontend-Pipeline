...
const menuItems = [
  {
    "id": "sour-duck-burger",
    "name": "Draft Wagyu Double Burger",
    "category": "Wood-Fired Burgers",
    "price": "14.50",
    "badge": "House Sourdough Bun",
          ...
          <div className="flex flex-wrap items-center gap-2 bg-white/5 p-1.5 rounded-full border border-white/10">
            {categories.map((cat: any) => (
              <button
                ...
                style={{
                  backgroundColor: selectedCategory === cat ? "#EA580C" : "transparent",
                }}
              >
                {cat}
              </button>
          ...
          {filteredItems.map((item: any) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pt-1">
                <h3 className="type-display text-xl sm:text-2xl text-white font-bold leading-tight group-hover:text-[#EA580C] transition-colors">
                  {item.name}
                </h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            ...
            >
              ...
              <div className="space-y-3">
                <span className="text-xs uppercase font-bold tracking-widest block" style={{ color: "#EA580C" }}>
